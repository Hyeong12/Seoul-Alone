...
public class ComAdapter extends RecyclerView.Adapter<ComAdapter.ViewHolder> {
    ...
    private ArrayList<ComData> mDataset;
    ...
    public ComAdapter(Context context, ArrayList<ComData> myDataset){
    ...
    public void onBindViewHolder(ViewHolder holder, final int position){
        ...
        Picasso.with(context).load(mDataset.get(position).image_url).placeholder(R.drawable.error).
